...
async def overview(
    *,
    ...
    threshold_g: Annotated[float | None, Query(default=None, ge=0)],
...
async def low_stock(
    *,
    ...
    allow_archived: bool = False,
    threshold_g: Annotated[float | None, Query(default=None, ge=0)],
    limit: Annotated[int, Query(default=20, ge=1, le=200)],
    location: str | None = None,
    material: str | None = None,
    vendor_id: Annotated[str | None, Query(pattern=r"^-?\d+(,-?\d+)*$")] = None,
    filament_id: Annotated[str | None, Query(pattern=r"^-?\d+(,-?\d+)*$")] = None,
...
async def recent_activity(
    *,
    db: Annotated[AsyncSession, Depends(get_db_session)],
    allow_archived: bool = False,
    days: Annotated[int, Query(default=30, ge=1, le=365)],
    limit: Annotated[int, Query(default=20, ge=1, le=200)],
    location: str | None = None,
    material: str | None = None,
    vendor_id: Annotated[str | None, Query(pattern=r"^-?\d+(,-?\d+)*$")] = None,
